...
public record SendFile(ReadErrorResponse readErrorResponse, WriteMultipart writeMultipart) {
    ...
    public void sendFileRequest(String urlString, MultipartFile file, String message) throws IOException {
        ...
        try (OutputStream out = conn.getOutputStream()) {
            writeMultipart.writeMultipartData(out, boundary, file, message);
        }
